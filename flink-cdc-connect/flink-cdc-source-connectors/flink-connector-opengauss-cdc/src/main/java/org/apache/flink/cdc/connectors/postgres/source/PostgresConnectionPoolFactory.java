...
/** A connection pool factory to create pooled OpenGauss {@link HikariDataSource}. */
public class PostgresConnectionPoolFactory extends JdbcConnectionPoolFactory {
    /**
     * Use jdbc:postgresql:// so Hikari/Driver accepts URL when opengauss-jdbc or pg driver is on
     * classpath. OpenGauss JDBC is protocol-compatible with this URL form.
     */

    ...
    protected void initPublication() {
        ...
        if (PostgresConnectorConfig.LogicalDecoder.PGOUTPUT.equals(plugin)) {
            ...
            try {
                ...
                // Use jdbcConnection.connection() instead of pgConnection() for OpenGauss
                // to avoid OpenGauss EOF issue. See: https://opengauss.org/zh/blogs/wangyuxuan/Flink-cdc-connector.html

...
public class PostgresConnection extends JdbcConnection {
    ...
    private static void validateServerVersion(Statement statement) throws SQLException {
        ...
        // OpenGauss uses different version numbering; relax check for OpenGauss compatibility
        // See: https://opengauss.org/zh/blogs/wangyuxuan/Flink-cdc-connector.html
        if (majorVersion < 9 || (majorVersion == 9 && minorVersion < 4)) {
            LOGGER.warn(
                    "Database version {}.{} is lower than PostgreSQL 9.4; continuing for OpenGauss compatibility",
                    majorVersion,
                    minorVersion);
        }
    }
